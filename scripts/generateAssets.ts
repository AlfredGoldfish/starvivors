...
import {
  ...
  BACKGROUND_MODE,
  DEFAULT_STYLE_SLUG,
  MANUAL_BACKGROUND_REMOVAL_EXPECTED,
  NEGATIVE_PROMPT,
  type AssetCategory,
...
function createBatchManifest({
  ...
  return {
    ...
    manualBackgroundRemovalExpected: MANUAL_BACKGROUND_REMOVAL_EXPECTED,
    transparentBackgroundRequested: false,
    backgroundRemovalMode: "manual",
    countRequested: requestedFiles.length,
