...
export const ENEMY_LAB_BEHAVIOR_IDS = [
  'directChase',
  'ambushReveal',
  'berserkChase',
  'orbiterCage',
  ...
  'reflectorPulse',
  'phaseTeleport'
] as const satisfies readonly EnemyLabBehaviorId[];
...
export const ENEMY_LAB_DEFINITIONS: EnemyLabDefinition[] = [
  {
    ...
    sizeProfile: createEnemySizeProfile('scout', 20, 2.2),
    shapeRecipe: createMonochromeShapeRecipe('arrow-diamond', 2.2, ['nose-line']),
    effectRecipe: {
      spawn: { kind: 'blink-ring', color: 0xdce8f5, durationMs: 360, radius: 38, intensity: 0.9 },
      move: { kind: 'spark-trail', color: 0xff5964, durationMs: 190, length: 28, intensity: 0.75 },
      telegraph: { kind: 'line-sweep', color: 0xff5964, durationMs: 300, length: 76, intensity: 0.45 },
      ...
      death: { kind: 'shard-burst', color: 0xdce8f5, durationMs: 360, radius: 64, intensity: 0.75 }
    },
  ...
  },
  {
    ...
    tier: 2,
    visualStyle: 'monochrome-outline',
    sizeProfile: createEnemySizeProfile('wedge-striker', 25, 2.8),
    shapeRecipe: createMonochromeShapeRecipe('wedge', 2.8, ['nose-line']),
    effectRecipe: {
  ...
  },
  {
    ...
    tier: 3,
    visualStyle: 'monochrome-outline',
    sizeProfile: createEnemySizeProfile('hex-tank', 40, 3.6),
    shapeRecipe: createMonochromeShapeRecipe('hex', 3.6, ['core-ring']),
    effectRecipe: {
  ...
  },
  {
    ...
    weapon: { id: 'lab-frost-needle', cooldownMs: 1450, projectileSpeed: 390, damage: 6, range: 950 },
  ...
  },
  {
    ...
    weapon: { id: 'lab-arc-bolt', cooldownMs: 1650, projectileSpeed: 360, damage: 5, range: 820 },
    rewards: { scrap: 4, xp: 22 }
  },
  {
    id: 'combat-summoner',
    ...
    weapon: { id: 'lab-summoner-shot', cooldownMs: 1550, projectileSpeed: 420, damage: 9, range: 1000 },
