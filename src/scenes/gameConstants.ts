...
export const CAMERA_LOOK_AHEAD_DISTANCE = 180;
export const CAMERA_LOOK_AHEAD_LERP = 0.085;
...
export const RUN_FUEL_MAX = 120;
export const RUN_FUEL_BASE_DRAIN_PER_SECOND = 1;
export const RUN_FUEL_THRUST_DRAIN_PER_SECOND = 0.16;
export const RUN_FUEL_EMERGENCY_THRUST_MULTIPLIER = 0.45;
export const EXTRACTION_ZONE_RADIUS = 88;
...
export const ENEMY_CONTACT_RECOIL_SPEED = 115;
