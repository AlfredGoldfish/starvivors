...
- Phase 4, entity runtime systems: in progress. Projectile runtime, basic asteroid runtime/collisions, asteroid breakup helpers, enemy runtime, and debris runtime have been extracted; hit resolution remains in `GameScene`.
