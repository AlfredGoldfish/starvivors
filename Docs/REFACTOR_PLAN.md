...
- Phase 4, entity runtime systems: in progress. Projectile weapon firing and projectile runtime updates have been extracted; hit resolution remains in `GameScene`.
