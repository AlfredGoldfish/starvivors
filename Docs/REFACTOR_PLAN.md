...
- Phase 4, entity runtime systems: in progress. Projectile runtime, basic asteroid runtime/collisions, and asteroid breakup helpers have been extracted; hit resolution remains in `GameScene`.
