...
- Phase 4, entity runtime systems: in progress. Projectile runtime and basic asteroid runtime updates have been extracted; hit/collision resolution remains in `GameScene`.
